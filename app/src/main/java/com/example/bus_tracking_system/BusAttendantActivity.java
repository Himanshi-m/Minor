...
import com.example.bus_tracking_system.Model.BusAttendantLiveLocationModel;
...
public class BusAttendantActivity extends AppCompatActivity {
    ...
    private CollectionReference mCollegeCollectionReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "College id through intent is : " + collegeId + " Attendant login id is : " + attendantEmail);
...
//        makeAttendance = findViewById(R.id.btnMarkAttendance);
        ...
        mCollegeCollectionReference = mFirebaseFirestore
                .collection("Colleges")
                .document(collegeId).collection("BusAttendantLocation");
    ...
    private void getUserDetails() {
        if (busAttendantLiveLocationModel == null) {
            ...
            mFirebaseFirestore.collection("College")
                    .document(collegeId)
...
//                                getCurrentLocation();
    ...
    private void saveUserLocation() {
        ...
        if (busAttendantLiveLocationModel != null) {
            DocumentReference documentReference = mCollegeCollectionReference
