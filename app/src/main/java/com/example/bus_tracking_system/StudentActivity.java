...
public class StudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(StudentActivity.this);

        Intent intent = getIntent();
        userEmail = intent.getStringExtra("studentEmail");
        collegeId = intent.getStringExtra("enteredCollegeId");
        Log.d(TAG, "Student Login email and college id is : " + userEmail + " " + collegeId);


        if (ActivityCompat.checkSelfPermission(StudentActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()) {
                                for (QueryDocumentSnapshot document : task.getResult()) {
                                    if (document.getString("studentEmail").equals(userEmail)) {
...
//            getBusLocationAndDirectionToHome(busLocation, dropLocation);
            ...
            ActivityCompat.requestPermissions(StudentActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_CODE);
        }
    }
