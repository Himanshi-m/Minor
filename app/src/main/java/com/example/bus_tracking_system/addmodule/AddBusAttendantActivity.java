...
public class AddBusAttendantActivity extends AppCompatActivity {
    ...
    CollectionReference mCollegeCollectionReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "CollegeId and userType : " + collegeId + " " + userType);

        mFirebaseAuth = FirebaseAuth.getInstance();
        mFirebaseFirestore = FirebaseFirestore.getInstance();
        mCollegeCollectionReference = mFirebaseFirestore.collection("Colleges");
        ...
        submitBusAttendantDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                usersModelForBusAttendant = new UsersModel(email, userType, collegeId);
    ...
    private void addUserInfoToFirestoreBusAttendantCollection(BusAttendantModel busAttendantModel) {
        mBusAttendantCollection = mCollegeCollectionReference.document(collegeId).collection("BusAttendant");
        mBusAttendantCollection
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(AddBusAttendantActivity.this, "Added data to college database", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
